...
import com.tomica.nioclient.messages.Message;
import com.tomica.nioclient.messages.impl.CM_PLAYERINFO;
import com.tomica.nioclient.messages.impl.SM_PLAYERINFO;
...
public class ReadWriteObjectTest {	
	...
	public void testWrite() {
		CM_PLAYERINFO serverMessage=null;
		try {
			serverMessage = new CM_PLAYERINFO(info, true);
		} catch (IOException e) {
	...
	public void testRead(){
		...
		try {
			SM_PLAYERINFO clientMessage=new SM_PLAYERINFO(buff.array());
